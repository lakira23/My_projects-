...
grid = pygame.image.load("tic_tac_toe/Resources/Grid.png")
O = pygame.image.load("tic_tac_toe/Resources/O.png")
X = pygame.image.load("tic_tac_toe/Resources/X.png")
menu = pygame.image.load("tic_tac_toe/Resources/Menu.png")
error_indication = pygame.image.load("tic_tac_toe/Resources/Error_indication.png")

won = pygame.image.load("tic_tac_toe/Resources/won.png")
draw = pygame.image.load("tic_tac_toe/Resources/draw.png")
#menu
menu_apperance = True
...
async def main():
    global runs, x_wins, o_wins, menu_apperance, player, player_num
    global game_runner, clicking, location_mouse, board
